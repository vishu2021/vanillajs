...
function createGradiant() {
  ...
  ring_last = Math.ceil(viewportwidth / 2 / offset + 4);
...
function animateOut() {
  for (var i = 1; i < ring_last + 1; i++) {
    ...
    //first four rings after to the active one, are painting slightly differently
    else if (i === ring - 1)
      gradient.style.setProperty("--color" + Number(i), "rgba(0, 0, 0, 0.20)");
    else if (i === ring - 2)
      gradient.style.setProperty("--color" + Number(i), "rgba(0, 0, 0, 0.40)");
    else if (i === ring - 3)
      gradient.style.setProperty("--color" + Number(i), "rgba(0, 0, 0, 0.60)");
    else if (i === ring - 4)
      gradient.style.setProperty("--color" + Number(i), "rgba(0, 0, 0, 0.80)");
    //all other rings after the active are painted in defined color
