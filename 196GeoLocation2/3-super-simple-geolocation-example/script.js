  ...
  **/
  if ("geolocation" in navigator) {
    ...
    $(".pure-button")
      ...
      .addClass("pure-button-success"); // change button style
  }
  ...
  function requestLocation() {
    ...
    **/
    ...
    function error(err) {
      ...
      $(".pure-button")
        .removeClass("pure-button-primary")
        .addClass("pure-button-error"); // change button style
    }
  } // end requestLocation();
...
$(".pure-button").on("click", function () {
  // show spinner while get location() does its thing
