...
form.addEventListener("submit", function (e) {
  ...
  // console.log("parseInt(amount.value) :", parseInt(amount.value));
  const random = Math.floor(Math.random() * text.length);
  //console.log("random :", random);
  if (isNaN(value) || value <= 0 || value > 9) {
    //console.log("value :", value);
    alert(
      "Please enter values greater than 1 and less than 10 in input field to show multiple paragraph. For now, random text of one paragraph will be shown for unaligned values."
    );
