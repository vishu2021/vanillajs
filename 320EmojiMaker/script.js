...
eyesBtn.addEventListener("click", () => {
  eyes.setAttribute(
    "src",
    `https://d289lqr9w22fzu.cloudfront.net/orientation-block/assets/images/eye-${counter2}.svg`
  );
  counter2 = counter2 < totalCounts.eyeCount - 1 ? counter2 + 1 : 0;
});
eyebrowsBtn.addEventListener("click", () => {
  eyebrows.setAttribute(
    "src",
    `https://d289lqr9w22fzu.cloudfront.net/orientation-block/assets/images/eyebrow-${counter3}.svg`
  );
...
mouthBtn.addEventListener("click", () => {
  mouth.setAttribute(
    "src",
    `https://d289lqr9w22fzu.cloudfront.net/orientation-block/assets/images/mouth-${counter4}.svg`
  );
