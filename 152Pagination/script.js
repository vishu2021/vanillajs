jQuery(document).ready(function () {
  ...
  /* 
		...
		*/
  var navigation_html =
    '<a class="previous_link disabled" href="javascript:previous();">Prev</a>';
  var current_link = 0;
...
function go_to_page(page_num) {
  ...
  /*get the page link that has long desc attribute of the current page and add active_page class to it
