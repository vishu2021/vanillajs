  ...
  if (isTouchDevice()) {
    ...
    if (
      ...
      currentDrop.insertAdjacentHTML(
        "afterbegin",
        `<img src= "https://d289lqr9w22fzu.cloudfront.net/orientation-block/assets/images/${currentElement.id}.png">`
      );
      count += 1;
    }
  } else {
    ...
    if (draggedElementData === droppableElementData) {
      ...
      e.target.insertAdjacentHTML(
        "afterbegin",
        `<img src="https://d289lqr9w22fzu.cloudfront.net/orientation-block/assets/images/${draggedElementData}.png">`
      );
      count += 1;
    }
  }
...
const creator = () => {
  ...
  for (let i of randomData) {
    ...
    flagDiv.innerHTML = `<img src="https://d289lqr9w22fzu.cloudfront.net/orientation-block/assets/images/${i}.png" id="${i}">`;
